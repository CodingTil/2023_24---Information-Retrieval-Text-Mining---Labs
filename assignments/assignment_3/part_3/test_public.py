...
@pytest.fixture(scope="module")
def rankings_ltr(request, es, trained_ltr_model, train_test_split, queries):
    ...
    request.config.cache.set("rankings/ltr", None)
...
@pytest.mark.long
def test_mean_rr(es, train_test_split, qrels, queries, rankings_ltr):
    """This test is 0.5 points"""
    _, test = train_test_split
